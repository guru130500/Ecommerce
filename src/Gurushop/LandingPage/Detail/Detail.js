...
const Detail = () => {
  ...
  const { id } = useParams();
  const{product,data}=UseProductData(id);
  ...
  function addtoCart(product) {
    if (isLoggedIn) {
      ...
      product["qty"] = 1;
      axios
        .post(`http://localhost:9000/cart`, product)
        .then((response) => {
            ...
            return (
              ...
              >
                ...
                <Box sx={{ height: "auto", width: "600px", padding: "40px" }}>
                  <h2>
                    <span>Name: {e.title}</span>
                  </h2>
                  <h2>
                    Price: <span style={{ color: "red" }}> ₹{e.price}</span>
                  </h2>
                  ...
                  <p>
                    ...
                    Additional ₹1500 off on Debit and Credit card Transactions.
                  </p>
                  <p>
                    <span style={{ fontWeight: "bold" }}>
                      <LocalOfferIcon
